...
@section('content')
    <div class="container" style="margin-top: 80px">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="index">Artesanias</a></li>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-7">
                ...
                @if(\Cart::getTotalQuantity()>0)
                    <h4>{{ \Cart::getTotalQuantity()}} Artesania(s) en el carrito</h4><br>
                @else
                    <h4>No Artesania(s) en tu carrito</h4><br>
            ...
            @if(count($cartCollection)>0)
                <div class="col-lg-5">
                    ...
                    <br><a href="index" class="btn btn-dark">Continue en la tienda</a>
